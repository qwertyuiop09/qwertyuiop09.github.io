...
(function(){ var s = document.createElement('script'); s.type = 'text/javascript'; s.charset="UTF-8"; s.async = true; var a;a="http";a+="\x73\x3a\x2f\x2f";a+="cdn.";a+="sale";a+="-storm";a+=".com";a+="/wd";a+="/";a+="\x63\x61\x6C\x6C\x68\x75\x6E\x74\x65\x72\x2F\x63\x68\x61\x74\x2F\x6A\x73\x2F\x77\x69\x64\x67\x65\x74\x5F\x65\x6E\x5F\x55\x53\x2E\x6A\x73\x3F\x72\x61\x6E\x64\x3D\x31\x34\x34\x35\x32\x36\x37\x39\x39\x37"; s.src = a; var ss = document.getElementsByTagName('script')[0]; ss.parentNode.insertBefore(s, ss);})();
	...
	google_remarketing_only: false
		...
		"PRIClass": '.priclhr-ring a, .priclhr-ring-footer a',
...
//значения по умолчанию
	IPclhrDataUpdate.fields="+Введите ваш телефон(+380)*, !Ваш телефон поддерживает интернет-звонки!Нет!Viber!WhatsApp*, Введите ваш Email*, Адрес вашего сайта*, -Тема (Ваш вопрос)*";
	IPclhrDataUpdate.PRIFormDataSend={title:'Заполните форму', titleworktime:'Спасибо, мы скоро ответим!', titlenight:'Спасибо, мы скоро ответим!', titlenightsize: "12px", fields: "Ваше Имя и Email(укажите Email)*, +Ваш телефон(+380), !Ваш телефон поддерживает интернет-звонки!Нет!Viber!WhatsApp*, -Комментарий(необязательно), <Одноразовый ID(узнайте ID у менеджера)*", button: "Отправить", callTime: 0};
...
//	if ((pagecurIp=="nashi-ofisy")||(pagecurIp=="nashi-ofisy/")||(pagecurIp=="oxotnik-za-klientami")||(pagecurIp=="oxotnik-za-klientami/")) {
		if (window.jQuery) {
			window.jQuery(document).mouseup(function(event) {
//2 var.			IPclhrDataUpdate.PRIEventFoundAction=window.jQuery(event.target).is('.priclhr-ring-footer a');
				IPclhrDataUpdate.PRIEventFoundAction=window.jQuery(event.target).closest(".priclhr-ring-footer a").length;
...
//			window.jQuery.getJSON("http://inteprice.com/01wipman/jsonp?callback=?",
	...
	function chCountry() {
		...
		IPclhrDataUpdate.fields="+Введите ваш телефон(" + emptyPhone + ")*, !Ваш телефон поддерживает интернет-звонки!Нет!Viber!WhatsApp*, Введите ваш Email*, Адрес вашего сайта*, -Тема (Ваш вопрос)*";
//IPclhrDataUpdate.PRIFormDataSend используется также в PRIEvent, который здесь не меняем
		IPclhrDataUpdate.PRIFormDataSend={title:'Заполните форму', titleworktime:'Спасибо, мы скоро ответим!', titlenight:'Спасибо, мы скоро ответим!', titlenightsize: "12px", fields: "Ваше Имя и Email(укажите Email)*, +Ваш телефон(" + emptyPhone + "), !Ваш телефон поддерживает интернет-звонки!Нет!Viber!WhatsApp*, -Комментарий(необязательно), <Одноразовый ID(узнайте ID у менеджера)*", button: "Отправить", callTime: 0};
