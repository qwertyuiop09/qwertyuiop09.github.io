...
//		"PRIFormDataPh": {title:'Уточните у менеджера необходимые данные', titleworktime:'Позвоните нам, узнайте подробности', titlenight:'Позвоните нам в рабочее время,<br>узнайте подробности', titlenightsize: "12px", fields: "Имя, Ваш Email, +Ваш телефон, Адрес сайта, -Комментарий, <Одноразовый ID(узнайте у менеджера)*", button: "Отправить", callTime: 1},
		"PRIFormData": {title:'Уточните у менеджера необходимые данные', titleworktime:'Мы свяжемся с Вами в ближайщее время', titlenight:'Мы свяжемся с Вами в рабочее время,<br>узнайте подробности', titlenightsize: "12px", fields: "Ваше Имя и Email*, +Ваш телефон, -Комментарий, <Одноразовый ID(узнайте у менеджера)*", button: "Отправить", callTime: 1},
		"PRIFormDataPh": {title:'Уточните у менеджера необходимые данные', titleworktime:'Мы свяжемся с Вами в ближайщее время', titlenight:'Мы свяжемся с Вами в рабочее время,<br>узнайте подробности', titlenightsize: "12px", fields: "Ваше Имя и Email*, +Ваш телефон, -Комментарий, <Одноразовый ID(узнайте у менеджера)*", button: "Отправить", callTime: 1},
