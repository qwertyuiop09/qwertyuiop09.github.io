...
//блокируем "родной" callback
window.jqIPAcode("<style>").prop("type", "text/css").html(".callback-block { display: none!important; visibility: hidden!important; }").appendTo("head");



//без предоплаты, логин менеджера
var intepriceIPL = 'uvencom.inteprice.com';
var intepriceCRT = '09.08.2017';
...
//		"CSS": '.callback-block { display: none!important; }',
