...
//		answer: 'Спасибо!</br>Ваш запрос принят, но линия консультанта сейчас занята</br></br>Консультант обязательно свяжется с Вами, если Вы указали верный номер телефона или email<script type="text/javascript">var p = document.getElementById("offline-form-inner");if(p&&p.height){p.height="70%";}</script>',
		answer: 'Спасибо!</br>Ваш запрос принят, но линия консультанта сейчас занята</br></br>Консультант обязательно свяжется с Вами, если Вы указали верный номер телефона или email<script type="text/javascript">var p = document.getElementById("offline-form-inner");alert(p)</script>',
		timeout: 15,
	        days: 15,
	        mobile: 0,
	        worktime: 0,
