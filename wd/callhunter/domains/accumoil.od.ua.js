...
var intepriceIPL = 'accumoil.inteprice.com';
var intepriceCRT = '09.08.2018';
...
//		"B1CFormDataPh": {title:'Купить в 1 клик', button:"Заказать", fields:'+Ваш телефон(+380)*, Ваш Email(необязательно), Количество(укажите количество)*, Цена[<!--chprice-->], Товар[<!--chitem-->], -Комментарий(необязательно)'},
		...
		"B1CFormDataPh": {title:'Купить в 1 клик', button:"Заказать", fields:'+Ваш телефон(+380)*, Ваш Email(необязательно), Количество(укажите количество)*, Цена[<!--[name=\'chprice\']-->], Товар[<!--[name=\'chitem\']-->], -Комментарий(необязательно)'},
...
//	"workDays": "Mon, Tue, Wed, Thu, Fri",
		...
		"AdwConvRemark": {
		google_conversion_id: 794779745,
...
*/
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "OougCKCAqIcBEOHA_foC",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "x6tTCKyAqIcBEOHA_foC",
		google_remarketing_only: false
			},
