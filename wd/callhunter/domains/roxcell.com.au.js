...
var intepriceIPL = 'roxcell.inteprice.com';
var intepriceCRT = '10.11.2016';
...
if (0) {
	...
	"titleworktime": "We will call you back in 1 min. 56 sec.",
//	"titleworktime": "We will call you back in a few minutes",
	"titlenight": "We will call you back during business hours",
	"titlenightcolor": "black",
	"titlenightsize": "12px",

	"button": "Call me!",

	"fields": "+Enter your phone number(+61)*, -What you'd like to discuss(ok to skip)",

	"alertQuickmessage": "Thank you, your message was sent",

	"alertSending": "Sending message ", // Идет отправка (Сообщение во время ожидания отправки сообщения)

	"alertSetCallTime": "Please advice best time to call you", // Укажите время звонка (Сообщение ошибки, если обязательно нужно указать время звонка в нерабочее время)
	...
	google_conversion_label: "XjbKCPrz2WsQ3uq6_QM",
...
//	"ClickElement": 'button[type=button][title="Add to Cart"]',
...
//		"ExtFormBtnFC": 'input[type="submit"][value="Send Email"], input[type="submit"][value="Submit"]',
	...
	"consultantSettings": {
		...
		"consultantSendContacts": 'Your contacts',
