...
//раскомментировать !!!
var intepriceIPL = 'tidream.inteprice.com';
var intepriceCRT = '22.01.2021';
...
//    "font_type": "normal",
	...
	"workDays": "Mon, Tue, Wed, Thu, Fri, Sat, Sun",
		...
		"AdwConvRemark": {
		google_conversion_id: 442935665,
...
//https://tidream.com/successful-checkout/


		"HitElement": "#content > h1",
		"HitElementHtml": {RegExp: '(Ваше замовлення успішно оформлено!)|(Ваш заказ успешно оформлен!)|(Your order has been placed!)', Flags: 'i'},
		...
		google_conversion_label: "E0uwCLTGnfIBEPHSmtMB",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "Lv9BCMDZ_PEBEPHSmtMB",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "YaBFCNi7jfIBEPHSmtMB",
		google_remarketing_only: false
			},
...
//		"titlenight": "Мы перезвоним в рабочее время",
		...
		"ExtFormFCOnly": {RegExp: '>([ ]*Отправить[ ]*|[ ]*Відправити[ ]*|[ ]*Submit[ ]*)<', Flags: 'i'},
		"ExtFormBtnFC": 'div.field-block a.button.btn.btn-primary',

		"ExtFormBtnFCFormPseudo": ".form-builder.box",
		"ExtFormBtnFCvalidAttr": "placeholder",
