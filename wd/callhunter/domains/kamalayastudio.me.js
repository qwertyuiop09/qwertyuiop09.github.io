...
var intepriceIPL = 'kamalayastudio.inteprice.com';
var intepriceCRT = '22.05.2018';
...
//	"consultantOn": "4",
	"consultantOn": "0",
		...
		"AdwConvRemark": {
		google_conversion_id: 863672045,
...
*/
		...
		"button": "Жду ответ!",
		"callTime": "0",
		"fields": "+Введите ваш телефон(+382)*, Введите ваш Email*, -Тема (Ваш вопрос)*",
		"emptyPhone": "+382",
	...
	if (pagecurIp=="RU.html") {

		IPclhrDataUpdate.hunterOn="1";
		IPclhrDataUpdate.showButton="1";
		IPclhrDataUpdate.consultantOn="4";
