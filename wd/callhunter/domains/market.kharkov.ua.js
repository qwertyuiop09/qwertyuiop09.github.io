...
*/
		...
		"B1CFormData": {title:'Купить в 1 клик', button:"Заказать", fields:'Продукция[<!--item-->], +Ваш телефон(+380)*, Количество(укажите количество)*, -Ваш комментарий(необязательно)'},
		"B1CFormDataPh": {title:'Купить в 1 клик', button:"Заказать", fields:'Продукция[<!--item-->], +Ваш телефон(+380)*, Количество(укажите количество)*, -Ваш комментарий(необязательно)'},
