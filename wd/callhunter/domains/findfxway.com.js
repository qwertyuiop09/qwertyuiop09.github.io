...
var intepriceIPL = 'findfxway.inteprice.com';
var intepriceCRT = '16.03.2017';
...
//		"ButtonMobileCSS": "display:none!important",
		...
		"button": "Жду ответ!",
		"callTime": "0",
		"fields": "+Введите ваш телефон(+7)*, Введите ваш Email*, -Тема (Ваш вопрос)*",
		"emptyPhone": "+7",
...
//	"workDays": "Mon, Tue, Wed, Thu, Fri",
	...
	google_conversion_label: "xRBWCIXrpW8Qiba2ywM",
...
//		"ExtFormFCStop": {RegExp: '<[^>]+(search|subscribe|password)', Flags: 'i'},
		"ExtFormFCStop": {RegExp: '<[^>]+(search|password)', Flags: 'i'},
