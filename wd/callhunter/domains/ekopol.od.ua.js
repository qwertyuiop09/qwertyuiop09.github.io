...
(function() {
		...
		s.charset = 'utf-8';
		s.async = true;
		s.src = '//online.inteprice.com/support/support.js?h=3183172be9293a8220409c74ef8eccf7';
...
/*
if (IPclhrData) {
    IPclhrData.ExtFormBtnFC = IPclhrData.ExtFormBtnFC + ', [type=submit], input[type=image]'
    IPclhrData.consultantOn="1";
	IPclhrData.consultantSmsMaxNotify="3";
	IPclhrData.consultantSmsTimeout="60";
	IPclhrData.consultantTimeoutNoSnd="0";
	IPclhrData.consultantMMFolder="";
//    IPclhrData.consultantShowInFrame=1;
}
*/
	...
	"consultantSettings": {
        ...
        "consultantAutoMsg": {timeout:15, days:15, mobile:0, worktime:0, name:"Офис-менеджер", message:"Здравствуйте! Если у Вас есть вопросы, я с удовольствием на них отвечу.",avatar:"https://f19aff30a120de38ca0c24b3eca9b09de686b08c.googledrive.com/host/0B5XusCO6HztZYjgxejdXTThCSDQ/ekopol.inteprice.com-chat.png"}
