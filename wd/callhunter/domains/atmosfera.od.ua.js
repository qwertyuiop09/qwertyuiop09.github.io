//блокируем надпись "Нет просмотров"
window.jqIPAcode(".post-info-views").ready(function () {
	window.jqIPAcode("<style>").prop("type", "text/css").html(".post-info-views { display: none!important; visibility: hidden!important; }").appendTo("head");
});



var intepriceIPL = 'atmosfera.inteprice.com';
var intepriceCRT = '24.09.2015';
...
(function() {
		...
		s.charset = 'utf-8';
		s.async = true;
//		s.src = '//online.inteprice.com/support/support.js?h=f93ea069b23d644fe12081cec069923a';
	        s.src = '//me-talk.ru/support/support.js?h=f93ea069b23d644fe12081cec069923a';
	...
	"AdwConvRemark": {
	google_conversion_id: 936616408,
	...
	google_conversion_label: "5xuyCK6ciGUQ2MPOvgM",
	...
	google_conversion_format: "3",
	google_conversion_color: "ffffff",
	google_conversion_label: "hch4CMPW1mUQ2MPOvgM",
	google_remarketing_only: false
		},
