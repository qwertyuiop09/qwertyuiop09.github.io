...
var intepriceIPL = 'bellinimebel.inteprice.com';
var intepriceCRT = '18.12.2019';
...
//https://bellinimebel.com.ua/thank-you-order/

		"HitElement": "span",
		"HitElementHtml": {RegExp: 'Благодарим за заказ. Мы свяжемся с Вами в ближайшее время!', Flags: 'i'},
...
//		"fields": "+Введите ваш телефон(+380)*, Введите ваш Email (Необязательно), -Тема (Ваш вопрос)*",
		"fields": "+Введите ваш телефон(+380)*, -Тема (Ваш вопрос)*",
		"emptyPhone": "+380",
		...
		"ExtFormBtnFC": 'form#callbackform input[type=submit], form#callbackform input[type=submit]',
		"ButtonSensitivity":	"0",
		"ButtonTransform": 3,
		"ButtonYMobile": 80,
		"ButtonXMobile": 0,
