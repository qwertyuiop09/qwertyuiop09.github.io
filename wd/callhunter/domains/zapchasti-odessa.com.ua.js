...
var intepriceIPL = 'autotrading.inteprice.com';
var intepriceCRT = '18.12.2015';
...
//		s.src = '//online.inteprice.com/support/support.js?h=4452d90c286ab805f74bd70a837c8927';
	...
	"titleworktime": "Мы перезвоним через 4 мин. 56 сек.",

		"MMFileType": "2",
		"ExtFormFCStop": {RegExp: '<[^>]+(search|subscribe|password)', Flags: 'i'},
//		"ExtFormBtnFC": IPclhrData.ExtFormBtnFC + ', [type=submit], input[type=image], input[type=button], button:not([type=reset])',
//		"ExtFormBtnFC": 'form[action="/request_to_manager/?action=send"] input[type=submit] , form[action="/register/"] input[type=submit]',
//		"ExtFormBtnFC": 'form[action="/request_to_manager/?action=send"] input[type=submit][value="Отправить запрос"] , input[type=submit][value="Зарегистрироватся"]',
		"ExtFormBtnFC": 'form[action="/request_to_manager/?action=send"] input[type=submit]',
