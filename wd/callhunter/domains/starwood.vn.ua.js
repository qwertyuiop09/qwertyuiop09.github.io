...
var intepriceIPL = 'starwood.inteprice.com';
...
//    "font_type": "normal",
	...
	"ButtonTransform": 0,
		...
		"AdwConvTime": {
		google_conversion_id: 801313757,
		google_conversion_language: "en",
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "s3eSCPPnrbYBEN2njP4C",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "FF7pCJqAubYBEN2njP4C",
		google_remarketing_only: false
			},
...
*/
	...
	"consultantSettings": {
		...
		Simulation: 1,
	        ...
	        prepare_message: 'Ваш запрос подготовлен к отправке официанту!<br><br>Для повышения качества нашего обслуживания, просим Вас представиться:',
	        prepare_forced: 1,
	        title: 'Ваш онлайн-официант',
	        title_off_forced: 1,
	        title_on_forced: 1,
		answer: 'Спасибо!</br>Ваш запрос уже передан официанту,</br>но его линия сейчас занята.</br></br>Официант свяжется с Вами чуть позже.',
		timeout: 15,
	        days: 14,
	        mobile: 0,
	        worktime: 0,
	        message: "Здравствуйте!</br>Я с удовольствием отвечу на вопросы и приму Ваш заказ.",
	        invite_off_forced: 1,
	        invite_on_forced: 1,
	        submit: "Заказать",
	        submit_forced: 1,
