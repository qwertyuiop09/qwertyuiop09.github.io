...
var intepriceIPL = 'agrovita.inteprice.com';
var intepriceCRT = '08.01.2019';
...
//	"workDays": "Mon, Tue, Wed, Thu, Fri",
	...
	"showButton": 	"0",
		...
		google_conversion_label: "8Dn_CImu6JIBEPnCne8C",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "R0dBCIKw6JIBEPnCne8C",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "DlenCK2x6JIBEPnCne8C",
		google_remarketing_only: false
		},
...
//		"fields": "+Введите ваш телефон(+380)*, Введите ваш Email*, -Тема (Ваш вопрос)*",
		...
		"ExtFormFCOnly": {RegExp: '<[^>]+("[ ]*Відправити[ ]+замовлення\![ ]*")', Flags: 'i'},
