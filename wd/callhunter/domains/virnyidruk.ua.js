...
//код для кампании-генератора
if (typeof SSCHunterGa != 'function')
	var SSCHunterGa=function(b,c){try{var a=window[window.GoogleAnalyticsObject];a(function(){a.getAll().forEach(function(a){a.send("event",b,c)})})}catch(d){}};
var pagecur=window.location.href.toString().split(window.location.host)[1];
if (pagecur.indexOf('wd=11') >= 0) {
...
//передаем в аналитикс Заинтересованность 3с
		try {
			if(typeof SSCHunterGa=="function")SSCHunterGa("Client Active","send_active2");
			console.log('SSCHunterGa Ok');
		} catch (e) {
			console.log('SSCHunterGa Error, name: ' + e.name + ", message: " + e.message);
		}
		...
		try {
			...
			if (1) {
				...
				setTimeout(function() {
					...
					google_conversion_format: "3",
					google_conversion_color: "ffffff",
					google_conversion_label: "D1PSCNjnwdwBEK2ew8wC",
					google_remarketing_only: false
						};
					console.log(typeof(window['google_trackConversion']));
					SSCHunterAdwordstrack(AdwConvTime);
		...
		try {
			...
			//if (1) {
				...
				setTimeout(function() {
					...
					google_conversion_format: "3",
					google_conversion_color: "ffffff",
					google_conversion_label: "DvtQCKKkuNwBEK2ew8wC",
					google_remarketing_only: false
						};
					console.log(typeof(window['google_trackConversion']));
					SSCHunterAdwordstrack(AdwConvTime);
...
//	"showButton": 	"2",
	...
	"ButtonPlace":	"LeftBottom",
		...
		google_conversion_color: "ffffff",
//for one
		google_conversion_label: "ymHiCNSgnLMBEK2ew8wC",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "jAawCIjJl7MBEK2ew8wC",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "vEP6CInsmLMBEK2ew8wC",
		google_remarketing_only: false
			},
...
//		"ExtFormBtnFC": '[type=submit], input[type=image], input[type=button], button:not([type=reset])',
		"ExtFormBtnFC": 'form#w3.feedback-form [type=submit], form#w3.feedback-form button:not([type=reset])',
		"ButtonSensitivity":	"0",
		"ButtonTransform": 3,
