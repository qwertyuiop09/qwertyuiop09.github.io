...
var intepriceIPL = 'vinkod.inteprice.com';
var intepriceCRT = '01.02.2018';
...
/*
отключаем на время теста (май 19)
...
// размещение кнопки (справа внизу RightBottom, справа вверху RightTop, слева внизу LeftBottom, слева вверху LeftTop)
		...
		"MMFileType": "2",
		"ExtFormFCStop": {RegExp: '<[^>]+(search|subscribe|password|Войти|Зарегистрироваться|price_min|price_max|Оформить заказ|Подобрать|Сохранить|Восстановить)', Flags: 'i'},
