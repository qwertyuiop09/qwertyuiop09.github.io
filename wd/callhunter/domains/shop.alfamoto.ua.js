...
var intepriceIPL = 'alfamoto.inteprice.com';
var intepriceCRT = '05.11.2015';
...
(function() {
		...
		s.charset = 'utf-8';
		s.async = true;
		s.src = '//online.inteprice.com/support/support.js?h=6e3830ef8b5d443588b7a4ad3d9cfdbb';
	...
	"fields": "+Введите ваш телефон(+380)*, !Тема звонка!!Запчасти!Мототехника!Аксессуары!Вопрос Механику!Проверить заказ!Другой вопрос*, -Ваш комментарий(необязательно)",
...
//		"ExtFormBtnFC": IPclhrData.ExtFormBtnFC + ', [type=submit], input[type=image], input[type=button], button:not([type=reset])',
		"ExtFormBtnFC": '#send_order_tbl [type=submit]',
		"ButtonSensitivity":	"0",
		"consultantOn": "1",
