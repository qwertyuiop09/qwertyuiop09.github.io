...
var intepriceIPL = 'scaena.inteprice.com';
...
(function() {
		...
		s.charset = 'utf-8';
		s.async = true;
//		s.src = '//online.inteprice.com/support/support.js?h=baf506e3f0ff420303c088da22039f11';
	        s.src = '//me-talk.ru/support/support.js?h=baf506e3f0ff420303c088da22039f11';
...
//		"ExtFormBtnFC": IPclhrData.ExtFormBtnFC + ', [type=submit], input[type=image], input[type=button], button:not([type=reset])',
		"ExtFormBtnFC": IPclhrData.ExtFormBtnFC + ', form[action="/contact/"] input[type=submit]',
		"ButtonSensitivity":	"0",
		"consultantOn": "1",
