...
var SSCHunterCallback = function(type,undefined,undefined,undefined,undefined,undefined,Conv_value) { if (type == 200) { console.log ( 'ConvTime exist' ) } else if ((type >= 1)&&(type < 200)) { console.log ( 'ConvCHSnd exist' ) } else if (type == 201) { console.log ( 'Conv�lick exist' ) } else if (type == 202) { console.log ( 'ConvSubmit exist' ) } else if (type == 203) { console.log ( 'ConvHit exist' ) } else if (type == 204) { console.log ( 'ConvJivo exist' ) } else if (type == 205) { console.log ( 'CallWidget exist' ) } ; if (typeof Conv_value != 'undefined') { console.log ( 'ConvValue exist: ' + Conv_value ) }   }




var intepriceIPL = 'prestige-design.inteprice.com';
var intepriceCRT = '19.08.2016';
...
if (0) {
	...
	"AdwConvRemark": {
	google_conversion_id: 875516231,
	...
	google_conversion_label: "ysLoCO2HzmkQx6K9oQM",
	...
	google_conversion_format: "3",
	google_conversion_color: "ffffff",
	google_conversion_label: "aE45CO3qtGkQx6K9oQM",
	google_remarketing_only: false
		},
