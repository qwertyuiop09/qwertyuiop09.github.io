...
var intepriceIPL = 'truck-poin.inteprice.com';
var intepriceCRT = '29.08.2018';
...
//	"workDays": "Mon, Tue, Wed, Thu, Fri",
		...
		"AdwConvRemark": {
		google_conversion_id: 1001524163,
...
//		google_user_id = '<unique user id>',
		...
		"HitElement": "div.main_content > b",
		"HitElementHtml": {RegExp: 'Заказ сформирован', Flags: 'i'},
		...
		google_conversion_label: "TCx8CPPPoogBEMOXyN0D",
//for one		google_conversion_label: "p561CJXw23UQpbqOzgM",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "y3tYCOe7mYgBEMOXyN0D",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "yq_RCIzAmYgBEMOXyN0D",
		google_remarketing_only: false
			},
...
*/
		...
		"ExtFormFCOnly": {RegExp: '<[^>]+("[ ]*ОТПРАВИТЬ[ ]*"|\'[ ]*ОТПРАВИТЬ[ ]*\')', Flags: 'i'},
