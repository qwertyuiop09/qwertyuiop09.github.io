...
var intepriceIPL = 'igor4608.inteprice.com';
var intepriceCRT = '02.12.2015';
...
if (1) {
	...
	(function() {
		...
		s.charset = 'utf-8';
		s.async = true;
		s.src = '//online.inteprice.com/support/support.js?h=1a4dfbe84dda1858151db2c68f656970';
	...
	"workDays": "Mon, Tue, Wed, Thu, Fri",
		...
		"MMFileType": "2",
//перестают работать формы расчета (не приходит стандартная почта по формам обратной связи!!!!!!!!!!!)
