...
var intepriceIPL = 'kitchen.inteprice.com';
var intepriceCRT = '20.06.2018';
...
//    "font_type": "normal",
	...
	"workDays": "Mon, Tue, Wed, Thu, Fri, Sat:10:18, Sun:10:17",
		...
		"AdwConvRemark": {
		google_conversion_id: 800002440,
		...
		"HitElement": "h4.title",
		"HitElementHtml": {RegExp: 'Ваш заказ оформлен!', Flags: 'i'},
		...
		google_conversion_label: "6pKBCOGHvIQBEIijvP0C",
//for one		google_conversion_label: "p561CJXw23UQpbqOzgM",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "bnJdCIiIvIQBEIijvP0C",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "9btNCKiHvIQBEIijvP0C",
		google_remarketing_only: false
			},
...
*/
   		...
   		"SetCallWidget": {button: "div.lt-widget-wrap button.lt-bttn", phoneField:'div.lt-widget-wrap input.lt-i-label__input', phoneRegExp:'([0-9][\\s]*[0-9][\\s]*[0-9][\\s]*[0-9][\\s]*[0-9][\\s]*[0-9][\\s]*[0-9])|([^\\s]+\@[^\\s]+\\.[^\\s]+)'},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "4G0LCOTrs4QBEIijvP0C",
		google_remarketing_only: false
		},
