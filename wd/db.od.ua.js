	...
	var IPclhrDataUpdate = {
		...
		"fields": "+Введите ваш телефон(+380)*, !Тема звонка!!Вызов замерщика!Бронированные двери!Межкомнатные двери!Металлоизделия!Дверные замки!Другой вопрос*, -Ваш комментарий(необязательно)",
...
//		"consultantOn": "1",
	...
	"consultantSettings": {
        ...
        "consultantAutoMsg": {timeout:15, days:15, mobile:0, worktime:0, name:"Офис-менеджер", message:"Здравствуйте! Если у Вас есть вопросы, я с удовольствием на них отвечу.",avatar:"https://f19aff30a120de38ca0c24b3eca9b09de686b08c.googledrive.com/host/0B5XusCO6HztZYjgxejdXTThCSDQ/db.od.ua-chat.png"},
