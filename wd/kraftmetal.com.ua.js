...
(function() {
		...
		s.charset = 'utf-8';
		s.async = true;
//		s.src = '//online.inteprice.com/support/support.js?h=152c089677bb14ee6b3734359afff386';
	        s.src = '//me-talk.ru/support/support.js?h=152c089677bb14ee6b3734359afff386';
	...
	google_conversion_label: "3kf9CM3Z0WUQ9432zwM",
	...
	google_conversion_format: "3",
	google_conversion_color: "ffffff",
	google_conversion_label: "LBrxCJS23GUQ9432zwM",
	google_remarketing_only: false
		},
		...
		"MMFileType": "1",
//есть интернет-магазин и калькуляторы, нет форм, поэтому отключаем
...
//		"ExtFormBtnFC": IPclhrData.ExtFormBtnFC + ', [type=submit], input[type=image], input[type=button], button:not([type=reset])',
		...
		"ViewFormClick": 'a[href="/shop/"]',


		"B1CFormData": {title:'Купить <font color="green"><!--item--></font>', button:"Заказать", fields:'+Ваш телефон(+380)*, =Артикул[<!--kod-->], Продукция[<!--item-->], Количество(укажите количество)*, -Ваш комментарий(необязательно)'},
		"B1CFormDataPh": {title:'Купить <font color="green"><!--item--></font>', button:"Заказать", fields:'+Ваш телефон(+380)*, =Артикул[<!--kod-->], Продукция[<!--item-->], Количество(укажите количество)*, -Ваш комментарий(необязательно)'},
	...
	"consultantSettings": {
		...
		reviewsrem_forced: 1,
	        ...
	        "consultantAutoMsg1": {timeout:15, days:15, mobile:0, worktime:0, name:"Офис-менеджер", message:"Здравствуйте! Если у Вас есть вопросы, я с удовольствием на них отвечу.",avatar:"https://f19aff30a120de38ca0c24b3eca9b09de686b08c.googledrive.com/host/0B5XusCO6HztZYjgxejdXTThCSDQ/kraftmetal.com.ua-chat.png"}
