...
function clear_old_files($dir){
	...
	$expire_time = 3600; //1 час // ¬рем€ через которое файл считаетс€ устаревшим (в сек.)
...
//должен быть хот€ бы один символ и нет слешей внутри и в начале
//только поддиректори€ скрипта может быть указана в $dir
//защищаем от возможного удалени€ где-то файлов при неверной настройке $dir
		return;
	}
